...
export function CodefetchFilters() {
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Header */}
      <div className="container-compact border-b border-border-subtle">
        ...
        <p className="text-caption mt-1">Configure filters for file collection and output</p>
      </div>
          ...
          <Card className="card-enhanced section-spacing">
            ...
            <CardContent className="container-compact">
                ...
                <div className="list-compact">
                  {displayedExtensions.map((ext, index) => {
                    ...
                    return (
                      <label
                        key={ext}
                        className="flex items-center justify-between py-2 px-3 rounded-md cursor-pointer hover:bg-accent/5 transition-colors"
                      >
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            className="h-4 w-4"
                          />
                          <span className="text-body-sm font-mono">{ext}</span>
                        </div>
                        {fileCount && (
              ...
              <div className="element-spacing">
                <Label htmlFor="custom-extensions" className="text-body-sm">
                  Custom Extensions
                </Label>
                <Input
                  ...
                  className="font-mono text-body-sm input-enhanced mt-1.5"
                />
          ...
          <Card className="card-enhanced section-spacing">
            ...
            <CardContent className="container-compact">
              <Tabs defaultValue="files" className="w-full">
                ...
                <TabsContent value="directories" className="space-y-2 mt-2">
                  {/* Include Directories */}
                  <div className="space-y-1">
                    <Label className="text-[10px]">Include Directories</Label>
                    <div className="flex gap-1">
                      <Input
                        placeholder="e.g., src/"
                        value={newIncludeDir}
                  ...
                  {/* Exclude Directories */}
                  <div className="space-y-1">
                    <Label className="text-[10px]">Exclude Directories</Label>
                    <div className="flex gap-1">
                      <Input
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-72 rounded-none">
                    ...
                    <div className="p-2 space-y-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex items-center gap-1">
                          <Input
                            ...
                            className="flex-1 h-7 text-[11px] rounded-none"
                          />
                      ...
                      {/* Token Encoder */}
                      <div className="space-y-1">
                        <Label className="text-[10px]">Token Encoder</Label>
                        <Select
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="simple" className="text-[11px]">
                            ...
                            <SelectItem value="p50k" className="text-[11px]">
                              <div className="flex flex-col">
                            ...
                            <SelectItem value="cl100k" className="text-[11px]">
                              <div className="flex flex-col">
                            ...
                            <SelectItem value="o200k" className="text-[11px]">
                              <div className="flex flex-col">
                      ...
                      <div className="space-y-1">
                        <Label className="text-[10px]">Token Limiter Strategy</Label>
                        <div className="space-y-1">
                          <label className="flex items-start space-x-1.5 cursor-pointer">
                            ...
                            />
                            <div>
                              <span className="text-[11px] font-medium">Truncated</span>
                              <p className="text-[9px] text-muted-foreground">
                          ...
                          <label className="flex items-start space-x-1.5 cursor-pointer">
                            ...
                            />
                            <div>
                              <span className="text-[11px] font-medium">Spread</span>
                              <p className="text-[9px] text-muted-foreground">
